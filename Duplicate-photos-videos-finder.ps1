# ================================
# Duplicate Photos and Videos Finder
# ================================

# Set the folder to scan
$folder = "E:\Personal"

# Get all photo and video files (any extension)
$files = Get-ChildItem -Path $folder -Recurse -Include *.jpg, *.jpeg, *.png, *.gif, *.bmp, *.mp4, *.avi, *.mov -File
